...
constexpr uint32_t kGameWorldSpBytes = 44;
constexpr uint32_t kPathDataBytes = 40;
constexpr uint32_t kPathNodeBytes = 128;
constexpr uint32_t kPathNodeConstantBytes = 68;
constexpr uint32_t kPathLinkBytes = 12;
constexpr uint32_t kPathBaseNodeBytes = 16;
constexpr uint32_t kPathTreeBytes = 16;
constexpr uint32_t kPathTreeLeafInfoBytes = 8;
constexpr uint32_t kPathNodeIndexBytes = 2;
