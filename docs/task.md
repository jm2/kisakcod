...
3. Add exact-key, production-neutral adapters that reconstruct and authenticate the passive receipt composition and bind
...
4. Only after those gates, perform one atomic seven-site loader cutover: claim exact generations, stage/transfer
