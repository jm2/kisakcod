...
foreach(_marker IN ITEMS
    ...
    "std::strstr(value, \"..\")"
    "std::strstr(value, \"::\")"
    "constexpr unsigned char FoldAsciiCase("
...
require_contains(
    ...
    "MP SYSTEMINFO field checks preserve canonical absent-empty values")
foreach(_marker IN ITEMS
    "SV_CountSystemInfoTokens(sv_referencedIwds->current.string)"
    "sv_referencedIwdNames->current.string"
    "Referenced IWD checksum/name count mismatch"
    "Dvar_InfoString_Big(8, &complete)"
    "if (!complete)"
    "SV_SystemInfoValueMatches("
    "\"sv_referencedIwds\""
...
require_ordered(
    ...
    "\"sv_referencedIwdNames\""
    "\"sv_referencedFFCheckSums\""
    "IWD and fast-file field round trips retain publication order")
require_ordered(
    _mp_systeminfo
    "\"fs_game\""
    "SV_SetConfigstring(1, dest);"
